        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Spaces_ParkingAreas_ParkingAreaId",
            ...
            migrationBuilder.InsertData(
                table: "ParkingAreas",
                columns: new[] { "Id", "Name" },
                values: new object[] { 1, "North" });

            migrationBuilder.InsertData(
                table: "Spaces",
                columns: new[] { "Id", "Alias", "ParkingAreaId", "Reference" },
                values: new object[,]
                {
                    { 1, "1", 1, "North.Space.1" },
                    { 2, "2", 1, "North.Space.2" },
